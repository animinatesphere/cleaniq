  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9990] flex items-center gap-3">
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-white text-primary-dark font-black text-sm px-4 py-2 rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 whitespace-nowrap"
          >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40"
