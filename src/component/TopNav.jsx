      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
        <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <a href="https://linkedin.com/company/cleaniq" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-all hover:scale-110 opacity-70 hover:opacity-100 p-1.5 md:p-2 rounded-lg hover:bg-white/5">
