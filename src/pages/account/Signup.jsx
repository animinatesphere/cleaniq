...
export default function CustomerSignup() {
  ...
  const passwordStrength = () => {
    ...
    if (!p) return null;
    if (p.length < 6)
      return { label: "Weak", color: "bg-rose-400", width: "w-1/4" };
    if (p.length < 10)
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 font-bold text-sm mt-2">
            Track bookings, chat with admin, and more
          </p>
        </div>
          ...
          {step === "details" ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div className="text-center mb-6">
                ...
                <h3 className="font-extrabold text-primary-dark text-lg">
                  Verify your email
                </h3>
                <p className="text-slate-400 font-bold text-xs mt-2">
                  We sent a 6-digit code to{" "}
                  <span className="text-primary-dark">{form.email}</span>
                </p>
              </div>
              ...
              <button
                ...
                className="w-full py-4 text-slate-400 font-bold text-xs hover:text-primary transition-colors"
              >
                Back to details
              </button>
            </form>
