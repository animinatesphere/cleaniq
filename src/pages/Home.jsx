            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 items-stretch sm:items-center">
              ...
              <div className="flex w-full items-center gap-2 sm:gap-3 sm:justify-center">
                ...
                <a
                  ...
                  className="group inline-flex flex-1 sm:flex-none items-center justify-center gap-2
                   rounded-xl border border-white/15 bg-black px-3 py-2.5 sm:px-4 sm:py-2.5 lg:px-3 lg:py-2.5 lg:rounded-full
                   text-white shadow-lg shadow-black/30 transition-all duration-200
                   hover:bg-zinc-900 hover:border-white/25 active:scale-[0.97]
                   focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5 sm:h-6 sm:w-6 shrink-0">
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                  </svg>
                  <span className="flex min-w-0 flex-col items-start leading-none lg:hidden">
                    <span className="text-[8px] font-medium uppercase tracking-widest text-white/70">Download on the</span>
                    <span className="mt-0.5 whitespace-nowrap text-sm font-semibold tracking-tight">App Store</span>
                  </span>
                  <span className="hidden lg:inline text-xs font-semibold">App Store</span>
                </a>
                ...
                <a
                  ...
                  className="group inline-flex flex-1 sm:flex-none items-center justify-center gap-2
                   ...
                   focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
                >
                  <svg viewBox="0 0 512 512" aria-hidden="true" className="h-5 w-5 sm:h-6 sm:w-6 shrink-0">
                  ...
                  <span className="flex min-w-0 flex-col items-start leading-none lg:hidden">
                    <span className="text-[8px] font-medium uppercase tracking-widest text-white/70">Download for</span>
                    <span className="mt-0.5 whitespace-nowrap text-sm font-semibold tracking-tight">Android</span>
                  </span>
                  <span className="hidden lg:inline text-xs font-semibold">Android</span>
                </a>
              </div>
