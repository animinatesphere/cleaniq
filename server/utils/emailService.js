...
// ─── Universal booking status-update email (defined before templates to
...
<tr><td align="center">
<table width="640" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:6px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.09);">

  <!-- HEADER -->
  <tr><td style="background:#0A5C43;padding:32px 44px 26px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td valign="middle">
        <p style="margin:0;font-size:22px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;line-height:1;">Cleaniq Services</p>
        <p style="margin:5px 0 0;font-size:9px;font-weight:800;color:rgba(255,255,255,0.5);text-transform:uppercase;letter-spacing:2px;">Professional Cleaning Services</p>
      </td>
      <td valign="middle" align="right">
        <p style="margin:0;font-size:34px;font-weight:900;color:#ffffff;letter-spacing:-1px;line-height:1;">INVOICE</p>
        <p style="margin:6px 0 0;font-size:13px;font-weight:700;color:#6EE7B7;">${booking.bookingId}</p>
        <span style="display:inline-block;margin-top:10px;background:#6EE7B7;color:#064e3b;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:1.5px;padding:4px 14px;border-radius:999px;">&#10003; PAID IN FULL</span>
      </td>
    </tr></table>
  </td></tr>
  ...
  <tr><td style="background:#f0fdf4;border-top:3px solid #0A5C43;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="padding:11px 18px;border-right:1px solid #bbf7d0;width:25%;">
        ...
        <p style="margin:0;font-size:11px;font-weight:700;color:#0f172a;">${booking.bookingId}</p>
      </td>
      <td style="padding:11px 18px;border-right:1px solid #bbf7d0;width:25%;">
  ...
  <tr><td style="padding:28px 44px 24px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td valign="top" width="50%" style="padding-right:16px;">
        ...
        <p style="margin:3px 0 0;font-size:12px;color:#64748b;">${booking.customer.email}</p>
        ${booking.customer.phone ? `<p style="margin:2px 0 0;font-size:12px;color:#64748b;">${booking.customer.phone}</p>` : ""}
        ${booking.details?.address ? `<p style="margin:4px 0 0;font-size:12px;color:#64748b;line-height:1.5;">${booking.details.address}${booking.details.postcode ? ", " + booking.details.postcode : ""}</p>` : ""}
      </td>
      <td valign="top" width="50%" align="right" style="padding-left:16px;">
      ...
      <tbody>
        <tr style="background:#ffffff;">
          <td style="padding:16px;font-size:13px;font-weight:700;color:#0f172a;border-bottom:1px solid #f1f5f9;">
            ${booking.service}
            ${booking.details?.frequency ? `<br><span style="font-size:11px;color:#64748b;font-weight:500;">Frequency: ${booking.details.frequency}</span>` : ""}
            ${booking.details?.address ? `<br><span style="font-size:11px;color:#64748b;font-weight:500;">&#128205; ${booking.details.address}${booking.details.postcode ? ", " + booking.details.postcode : ""}</span>` : ""}
          </td>
          <td style="padding:16px;font-size:13px;color:#334155;font-weight:600;text-align:center;border-bottom:1px solid #f1f5f9;">${isFlat ? "Flat Rate" : `${booking.details?.duration || "N/A"} hrs`}</td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      ...
      <td style="width:220px;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#0A5C43;border-radius:12px;overflow:hidden;">
          <tr>
            <td style="padding:14px 18px;font-size:10px;font-weight:800;color:rgba(255,255,255,0.7);text-transform:uppercase;letter-spacing:1px;">Total Paid</td>
  ...
  <tr><td style="padding:0 44px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="background:#f0fdf4;border:1px solid #86efac;border-radius:12px;padding:24px;text-align:center;">
        <p style="margin:0;font-size:16px;font-weight:800;color:#065f46;">Thank you for choosing Cleaniq Services! &#127775;</p>
        <p style="margin:8px 0 16px;font-size:13px;color:#059669;">We hope you&#39;re delighted with your clean. We&#39;d love a review!</p>
        <a href="https://g.page/r/CTGJLR1Z7dySEBM/review" style="display:inline-block;background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:800;font-size:13px;">Leave a Review &#11088;</a>
      </td>
    </tr></table>
  </td></tr>
  ...
  <tr><td style="padding:0 44px 32px;text-align:center;">
    <a href="https://api.cleaniqservices.com/api/bookings/${booking._id}/invoice" style="display:inline-block;background:#0f172a;color:#6EE7B7;padding:16px 40px;border-radius:10px;text-decoration:none;font-weight:800;font-size:14px;letter-spacing:0.5px;">&#11015; Download PDF Receipt</a>
  </td></tr>
...
<table class="card" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;background:#fff;border-radius:4px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
  ...
  <!-- HEADER -->
  <tr><td style="background:#0A5C43;padding:36px 48px 28px;" class="pad">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td valign="middle">
        <p style="margin:0;font-size:22px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;line-height:1;">Cleaniq Services</p>
        <p style="margin:4px 0 0;font-size:9px;font-weight:800;color:rgba(255,255,255,0.55);text-transform:uppercase;letter-spacing:2px;">Professional Cleaning Services</p>
      </td>
      <td valign="middle" align="right">
        <p style="margin:0;font-size:34px;font-weight:900;color:#ffffff;letter-spacing:-1px;line-height:1;">INVOICE</p>
        <p style="margin:6px 0 0;font-size:13px;font-weight:700;color:#6EE7B7;">${booking.bookingId}</p>
        <table cellpadding="0" cellspacing="0" align="right" style="margin-top:10px;">
          <tr><td style="background:#fef3c7;border:1.5px solid #fde68a;border-radius:20px;padding:5px 16px;">
            <span style="font-size:10px;font-weight:900;color:#92400e;text-transform:uppercase;letter-spacing:1px;">&#9203; AWAITING PAYMENT</span>
          </td></tr>
        </table>
      </td>
    </tr></table>
  ...
  <tr><td style="padding:0 48px 32px;" class="pad">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:4px;">
      <tr><td style="background:#0A5C43;padding:22px 24px;border-radius:0 0 8px 8px;">
        <table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td style="font-size:15px;font-weight:800;color:rgba(255,255,255,0.75);text-transform:uppercase;letter-spacing:1px;">Amount Due</td>
          <td style="text-align:right;font-size:36px;font-weight:900;color:#ffffff;letter-spacing:-1px;line-height:1;">&#163;${booking.payment.amount}</td>
        </tr></table>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:0 48px 32px;" class="pad">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="background:#f0fdf4;border:1px solid #86efac;border-radius:12px;padding:24px;">
        <p style="margin:0;font-size:16px;font-weight:800;color:#065f46;">Payment Due</p>
        <p style="margin:8px 0 0;font-size:14px;color:#059669;line-height:1.6;">Your cleaning has been completed. Please arrange payment at your earliest convenience. Contact us at <a href="mailto:info@cleaniqservices.com" style="color:#0A5C43;font-weight:700;">info@cleaniqservices.com</a> with any queries.</p>
      </td>
    </tr></table>
  </td></tr>
...
<tr><td align="center" style="padding:32px 12px;">
  ...
  adminBookingCreatedEmail2: (booking) => {
    const dateStr = booking.schedule?.date
      ...
      : "";
    const extrasRows = (booking.details?.extras || []).map(extra =>
      `<tr><td style="padding:8px 0;font-size:13px;color:#1e293b;border-bottom:1px solid #e2e8f0;">&#10003;&nbsp; ${typeof extra === "object" && extra !== null ? extra.name + (extra.qty > 1 ? " &times;" + extra.qty : "") : extra}</td></tr>`
    ).join("");
    return `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
...
<style>
  @media only screen and (max-width:600px){
    ...
    .em-pad{padding:28px 22px!important}
    .em-hpad{padding:32px 22px!important}
    .em-twoCol td{display:block!important;width:100%!important;text-align:left!important}
  }
</style>
</head>
<body style="margin:0;padding:0;background-color:#eef0f3;font-family:Arial,Helvetica,sans-serif;">
  ...
  <table class="em-card" width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.07);">
          ...
          <tr>
            <td align="center">
              <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 16px;">
                <tr>
                  <td style="background:#6EE7B7;border-radius:50px;padding:6px 20px;">
                    <span style="font-size:11px;font-weight:800;color:#064e3b;text-transform:uppercase;letter-spacing:1.5px;">&#10003; Booking Confirmed</span>
                  </td>
                </tr>
              </table>
              <h1 style="margin:0 0 8px;color:#ffffff;font-size:26px;font-weight:800;letter-spacing:-0.5px;">Your clean is all set!</h1>
              <p style="margin:0;color:rgba(255,255,255,0.65);font-size:14px;">Thank you for choosing Cleaniq Services</p>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td class="em-pad" style="padding:40px 48px;">
        ...
        <p style="margin:0 0 28px;font-size:15px;color:#1e293b;line-height:1.7;">Hi <strong>${booking.customer.firstName}</strong>,<br>Your appointment has been confirmed by our team. Here are your full booking details:</p>

        <!-- Reference -->
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
          <tr>
            <td style="background:#f0fdf4;border:1.5px solid #6EE7B7;border-radius:10px;padding:18px 22px;">
              <p style="margin:0 0 4px;font-size:10px;font-weight:700;color:#0A5C43;letter-spacing:2px;text-transform:uppercase;">Booking Reference</p>
              <p style="margin:0;font-size:22px;font-weight:900;color:#0A5C43;letter-spacing:0.5px;">${booking.bookingId}</p>
            </td>
          </tr>
        </table>

        <!-- Service Details -->
        <p style="margin:0 0 10px;font-size:10px;font-weight:800;color:#94a3b8;letter-spacing:2px;text-transform:uppercase;">Service Details</p>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:28px;font-size:13px;">
          <tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;width:38%;">Service</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">${booking.service}</td>
          </tr>
          <tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Frequency</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">${booking.details?.frequency || "Once"}</td>
          </tr>
          <tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Duration</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">${booking.details?.duration || "TBC"} hours</td>
          </tr>
          ${dateStr ? `<tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Date</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">${dateStr}</td>
          </tr>` : ""}
          <tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Time</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">${booking.schedule?.timeSlot || "TBC"}</td>
          </tr>
          <tr>
            <td style="padding:12px 18px;color:#64748b;font-weight:600;background:#f8fafc;">Address</td>
            <td style="padding:12px 18px;color:#1e293b;font-weight:700;">${booking.details?.address || ""}${booking.details?.postcode ? ", " + booking.details.postcode : ""}</td>
          </tr>
        </table>

        ${extrasRows ? `<!-- Extras -->
        <p style="margin:0 0 10px;font-size:10px;font-weight:800;color:#94a3b8;letter-spacing:2px;text-transform:uppercase;">Included Extras</p>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;padding:4px 18px;margin-bottom:28px;">
          ${extrasRows}
        </table>` : ""}
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
          <tr>
            <td style="background:#0A5C43;border-radius:10px;padding:20px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="font-size:13px;font-weight:700;color:rgba(255,255,255,0.75);">Total Due</td>
                  <td align="right" style="font-size:26px;font-weight:900;color:#ffffff;">&#163;${booking.payment?.amount || "TBC"}</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
          <tr>
            <td style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:20px 22px;">
              <p style="margin:0 0 12px;font-size:12px;font-weight:800;color:#92400e;text-transform:uppercase;letter-spacing:1px;">Important Reminders</p>
              <p style="margin:0 0 8px;font-size:13px;color:#b45309;line-height:1.6;">&#8226;&nbsp; Please ensure someone is home or provide access instructions</p>
              <p style="margin:0 0 8px;font-size:13px;color:#b45309;line-height:1.6;">&#8226;&nbsp; You'll receive a reminder 24 hours before your appointment</p>
              <p style="margin:0;font-size:13px;color:#b45309;line-height:1.6;">&#8226;&nbsp; Our cleaner will be in touch 30 minutes before arrival</p>
            </td>
          </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td align="center">
              <a href="https://cleaniqservices.com" style="display:inline-block;background-color:#0A5C43;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;padding:14px 36px;border-radius:8px;">View My Booking</a>
            </td>
          </tr>
        </table>

        <p style="margin:28px 0 0;font-size:13px;color:#64748b;line-height:1.7;text-align:center;">Questions? Contact us at <a href="mailto:info@cleaniqservices.com" style="color:#0A5C43;font-weight:700;text-decoration:none;">info@cleaniqservices.com</a></p>
    ...
    <!-- FOOTER -->
    <tr>
      <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:22px 48px;text-align:center;">
        <p style="margin:0 0 4px;font-size:12px;color:#94a3b8;">&copy; 2026 Cleaniq Services Ltd &nbsp;&middot;&nbsp; Manchester, UK</p>
        <p style="margin:0;font-size:12px;color:#94a3b8;"><a href="mailto:info@cleaniqservices.com" style="color:#0A5C43;text-decoration:none;">info@cleaniqservices.com</a></p>
      </td>
    </tr>
...
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>How was your clean? — Cleaniq Services</title>
<style>
  @media only screen and (max-width:600px){
    .em-card{width:100%!important;border-radius:0!important}
    .em-pad{padding:28px 22px!important}
...
<tr><td align="center" style="padding:32px 12px;">
  <table class="em-card" width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.07);">
    ...
    <tr>
      <td class="em-hpad" style="background-color:#0A5C43;padding:44px 48px;text-align:center;">
        <img src="https://cleaniqservices.com/preview.jpg" alt="Cleaniq Services" width="70" style="border-radius:10px;display:block;margin:0 auto 18px;" />
        <p style="margin:0;color:#6EE7B7;font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;">Service Complete</p>
        <h1 style="margin:8px 0 0;color:#ffffff;font-size:26px;font-weight:800;letter-spacing:-0.5px;">How did we do? &#11088;</h1>
        <p style="margin:10px 0 0;color:rgba(255,255,255,0.6);font-size:14px;">Your feedback means everything to us</p>
      </td>
    </tr>
    ...
    <tr>
      <td class="em-pad" style="padding:40px 48px;">
        <p style="margin:0 0 24px;font-size:15px;color:#1e293b;line-height:1.7;">Hi <strong>${booking.customer.firstName}</strong>,</p>
        <p style="margin:0 0 28px;font-size:14px;color:#475569;line-height:1.7;">Thank you for choosing Cleaniq Services for your <strong>${booking.service}</strong>. We hope you're delighted with the result!</p>

        <!-- Booking ref -->
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
          <tr>
            <td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:14px 20px;">
              <p style="margin:0 0 2px;font-size:10px;font-weight:700;color:#166534;letter-spacing:2px;text-transform:uppercase;">Booking Reference</p>
              <p style="margin:0;font-size:18px;font-weight:800;color:#0A5C43;">${booking.bookingId}</p>
            </td>
          </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px;">
          <tr>
            <td style="text-align:center;padding:8px 0 4px;">
              <p style="margin:0 0 14px;font-size:11px;font-weight:700;color:#94a3b8;letter-spacing:2px;text-transform:uppercase;">Share your experience</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
          <tr>
            <td align="center" style="padding:20px 0 8px;">
              <a href="https://g.page/r/CTGJLR1Z7dySEBM/review" style="display:inline-block;background-color:#0A5C43;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;padding:17px 44px;border-radius:8px;">Leave a Google Review</a>
            </td>
          </tr>
        </table>

        <p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;line-height:1.6;">It only takes 30 seconds and helps other customers find us. Thank you so much!</p>
      </td>
    </tr>
  ...
  // ─── PAYMENT LINK EMAIL ────────────────────────────────────────────────────
  paymentLinkEmail: (booking, items, totalAmount, payUrl, note) => `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Payment Request — Cleaniq Services</title>
<style>
  @media only screen and (max-width:600px){
    .em-card{width:100%!important;border-radius:0!important}
    .em-pad{padding:28px 22px!important}
  ...
  <table class="em-card" width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.07);">
    ...
    <tr>
      <td class="em-hpad" style="background-color:#0A5C43;padding:44px 48px;text-align:center;">
        <img src="https://cleaniqservices.com/preview.jpg" alt="Cleaniq Services" width="70" style="border-radius:10px;display:block;margin:0 auto 18px;" />
        <p style="margin:0;color:#6EE7B7;font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;">Action Required</p>
        <h1 style="margin:8px 0 0;color:#ffffff;font-size:26px;font-weight:800;letter-spacing:-0.5px;">Payment Request</h1>
        <p style="margin:10px 0 0;color:rgba(255,255,255,0.6);font-size:14px;">Secure payment for your Cleaniq services</p>
      </td>
    </tr>
    ...
    <tr>
      <td class="em-pad" style="padding:40px 48px;">
        <p style="margin:0 0 26px;font-size:15px;color:#1e293b;line-height:1.7;">Hi <strong>${booking.customer.firstName}</strong>,<br>A payment has been prepared for your booking. Please review the details below and pay securely online.</p>
        ...
        <!-- Items table -->
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:8px;font-size:13px;">
          <tr style="background:#0f172a;">
            <th style="padding:12px 16px;font-size:8px;font-weight:800;color:#6ee7b7;text-transform:uppercase;letter-spacing:1px;text-align:left;">Service / Item</th>
            <th style="padding:12px 16px;font-size:8px;font-weight:800;color:#6ee7b7;text-transform:uppercase;letter-spacing:1px;text-align:center;width:60px;">Qty</th>
            <th style="padding:12px 16px;font-size:8px;font-weight:800;color:#6ee7b7;text-transform:uppercase;letter-spacing:1px;text-align:right;width:100px;">Amount</th>
          </tr>
          ${(items || []).map((item) => `
          <tr style="border-bottom:1px solid #f1f5f9;">
            <td style="padding:14px 16px;font-size:13px;font-weight:600;color:#1e293b;">${item.name}</td>
            <td style="padding:14px 16px;font-size:13px;color:#64748b;text-align:center;">${item.qty || 1}</td>
            <td style="padding:14px 16px;font-size:13px;font-weight:700;color:#0f172a;text-align:right;">&#163;${((item.amount || 0) * (item.qty || 1)).toFixed(2)}</td>
          </tr>`).join("")}
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
          <tr>
            ...
            <td style="width:200px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#0A5C43;border-radius:0 0 10px 10px;overflow:hidden;">
                <tr>
                  <td style="padding:14px 18px;font-size:10px;font-weight:800;color:rgba(255,255,255,0.7);text-transform:uppercase;letter-spacing:1px;">Total Due</td>
                  <td style="padding:14px 18px;font-size:22px;font-weight:900;color:#ffffff;text-align:right;">&#163;${Number(totalAmount).toFixed(2)}</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
          <tr>
            <td style="background:#fffbeb;border-left:4px solid #f59e0b;border-radius:0 8px 8px 0;padding:16px 18px;">
              <p style="margin:0 0 4px;font-size:10px;font-weight:800;color:#b45309;text-transform:uppercase;letter-spacing:1px;">Note from Cleaniq</p>
              <p style="margin:0;font-size:13px;color:#78350f;line-height:1.6;">${note}</p>
            </td>
          </tr>
        </table>
        ` : ""}
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:12px;">
          <tr>
            <td align="center" style="padding:4px 0 12px;">
              <a href="${payUrl}" style="display:inline-block;background-color:#0A5C43;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;padding:17px 48px;border-radius:8px;letter-spacing:0.3px;">Pay Securely Now</a>
            </td>
          </tr>
        </table>
        <p style="margin:0 0 32px;font-size:12px;color:#94a3b8;text-align:center;">Powered by Stripe &mdash; 100% Secure &amp; Encrypted</p>

        <!-- Bank transfer option -->
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="border-top:1px solid #e2e8f0;padding-top:24px;">
              <p style="margin:0 0 14px;font-size:10px;font-weight:700;color:#94a3b8;letter-spacing:2px;text-transform:uppercase;">Or pay by bank transfer</p>
            </td>
          </tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;font-size:13px;margin-bottom:16px;">
          <tr><td style="padding:11px 16px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;width:40%;">Bank</td><td style="padding:11px 16px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">HSBC Bank</td></tr>
          <tr><td style="padding:11px 16px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Account Name</td><td style="padding:11px 16px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">Cleaniq Services Limited</td></tr>
          <tr><td style="padding:11px 16px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Sort Code</td><td style="padding:11px 16px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">40-11-56</td></tr>
          <tr><td style="padding:11px 16px;color:#64748b;font-weight:600;background:#f8fafc;border-bottom:1px solid #e2e8f0;">Account No.</td><td style="padding:11px 16px;color:#1e293b;font-weight:700;border-bottom:1px solid #e2e8f0;">81106546</td></tr>
          <tr><td colspan="2" style="padding:12px 16px;background:#f0fdf4;border-top:1px solid #bbf7d0;">
            <p style="margin:0;font-size:13px;color:#166534;"><strong>Reference:</strong> Use <strong>${booking.bookingId}</strong> so we can match your transfer.</p>
          </td></tr>
        </table>
      </td>
    </tr>
